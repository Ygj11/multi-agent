...
async def test_rule_high_confidence_does_not_call_llm_router():
    ...
    result = await node.select(
        ...
        entities={"policy_no": "9200100000458846", "customer_no": "C001"},
        query="查询保单 9200100000458846 可以做哪些保全项 保全实时查询 可做保全项查询",
    )
...
def test_optional_entities_score_and_required_missing_recorded():
    ...
    candidates = loader.match_candidates(intent="pos_query", entities={"policy_no": "9200100000458846"}, query="保全实时查询")
