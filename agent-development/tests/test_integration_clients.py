...
from app.integrations.partner_trace_api_client import PartnerTraceAPIClient
...
def test_future_api_client_methods_keep_request_and_trace_parameters():
    ...
    methods = [
        ...
        PartnerTraceAPIClient.get_request_detail,
        ...
        AuditAPIClient.write_tool_call_log,
        AuditAPIClient.query_tool_call_logs,
